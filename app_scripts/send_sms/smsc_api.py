...
SMSC_LOGIN = pythonix.settings.sms_login            # логин клиента
SMSC_PASSWORD = pythonix.settings.sms_password    # пароль или MD5-хеш пароля в нижнем регистре
...
def sendInfoEmployeer(phone_numbes, text_sms):
    smsc = SMSC()
    smsc.send_sms(phone_numbes, text_sms, sender=pythonix.settings.sms_sender_name)
